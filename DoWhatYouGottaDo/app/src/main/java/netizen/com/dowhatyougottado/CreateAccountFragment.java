...
import netizen.com.dowhatyougottado.server.Controller;
...
public class CreateAccountFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, //----------------------------------------
        ...
        Button createButton = v.findViewById(R.id.createBtn);
        createButton.setOnClickListener(this);

        accountNameEditText = v.findViewById(R.id.accountNameText);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onFragmentInteraction(new Founder());
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onFragmentInteraction(Founder newFounder);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.createBtn:
                createAccount(accountNameEditText.getText().toString());
                break;
        }
    }
    ...
    public void createAccount(String accountName){
        Log.e("XD", "createAccount " + accountName+ " to searrch");
        ...
        Call<Founder> call = request.createFounder(new Founder(accountNameEditText.getText().toString()));
        call.enqueue(new Callback<Founder>(){
            @Override
            public void onResponse(Call<Founder> call, Response<Founder> response) {
                Founder newFounder = response.body();

                mListener.onFragmentInteraction(newFounder);
